...
<head>
	...
	<title>Category - <?php echo $show->categoryShowName($id); ?></title>
...
<body>
    ...
    <div class="main">
		<div align = "center"class="create-post-style">
			<form>
				<input type="text" name="crtPost" placeholder="Create Post" onClick="document.location.href='../public/submit.php?catid=<?php echo $id;?>'">
			</form>
	</div>
	<?php $thread->showThreads($id);?>
